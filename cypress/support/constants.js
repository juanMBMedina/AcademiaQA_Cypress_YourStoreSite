...
export const PAGE_MSSGS = {
  ...
  LOGOUT_PAGE: {
    SUCCES_LOGUT: "You have been logged off your account. It is now safe to leave the computer.",
  },
  REGISTER_PAGE: {
    SUCCES_REGISTER: "Congratulations! Your new account has been successfully created!",
